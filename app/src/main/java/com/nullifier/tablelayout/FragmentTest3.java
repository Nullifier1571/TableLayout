...
public class FragmentTest3 extends Fragment implements ITableBind {
    ...
    public void initTableInfo() {
        ...
        mFirstTableItemData.tableName = "发布";//table名称
        mFirstTableItemData.messageCount = 0;//消息个数
        mFirstTableItemData.isShowRedPoint = false;//消息个数
        mFirstTableItemData.tableMode = TableMode.MODE_PUBLISH;//table模式
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_test_three, null);
    }
}
