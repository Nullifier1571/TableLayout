...
public class FragmentTest2 extends Fragment implements ITableBind {
    ...
    public void initTableInfo() {
        ...
        mFirstTableItemData.tableName = "消息";//table名称
        mFirstTableItemData.iconSelectedResId = R.mipmap.message_selected;
        mFirstTableItemData.iconDefaultResId = R.mipmap.message_unselected;
...
//table之间数据传递
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_test_two, null);
    }
}
